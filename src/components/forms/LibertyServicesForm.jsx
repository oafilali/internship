      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <input
            ...
            className="w-full border rounded px-3 py-2 text-sm text-gray-600 focus:outline-none focus:border-blue-500 mb-4"
          />
          <input
            type="text"
...
export default LibertyServicesForm; 